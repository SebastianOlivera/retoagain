...
```bash
python ejecutar_metricas_periodicas.py --csv entrada.csv --out_csv salida_periodos.csv --out_cycles_csv salida_ciclos.csv --days_per_period 2 --level_convention depth
```
...
Se agregan flags de convención de nivel en salida: `level_convention_usada`, `nivel_sign_flip_aplicado`, `nivel_es_profundidad_detectado`, `warning_convention_mismatch`.
